...
if ($msConn) {
    $querySql = "SELECT id_ordine, progressivo, stato, data, isReso FROM stato S JOIN ordine O ON S.id_ordine = O.id WHERE id_ordine = $idOrdine ORDER BY progressivo DESC LIMIT 1;";
    ...
    <div class="w3-card-4 pure-u-md-1-2 pure-u-1-1">
        ...
        <div class="w3-container">
            <table table style="margin: 0 auto;">
                <tr><th>ULTIMO STATO:              </th><td><?=$stato?></td></tr>
                <tr><th>ULTIMO AGGIORNAMENTO:      </th><td><?=$data?></td></tr>
                <tr><th>AVANZAMENTO STATO:         </th><td><?=$progressivo?></td></tr>
                <tr><th>E' UN RESO?                </th><td><?php if($isReso) echo "SI"; else echo "NO"; ?></td></tr>
            </table>
        </div>
